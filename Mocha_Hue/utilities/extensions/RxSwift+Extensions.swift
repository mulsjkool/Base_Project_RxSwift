...
extension ObservableType {
    public func delayStream(_ time: DispatchTimeInterval, scheduler: SchedulerType = MainScheduler.instance) -> Observable<Element> {
...
func ~> <T, O: ObserverType>(event: ControlEvent<T>, property: O) -> Disposable where O.Element == T {
