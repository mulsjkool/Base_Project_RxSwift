...
extension UILabel {
    ...
    func from(html: String) {
        ...
        let textAttributes = [NSAttributedString.Key.foregroundColor: textColor as Any,
                              NSAttributedString.Key.font: self.font as Any // This will cause html format issue
        ]
